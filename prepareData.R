...
geo <-  arrange(geo, State, StateName, County, City, Zip)
...
setnames(hviCondoZip, "RegionName", "Zip")
setnames(hviCondoCity, "RegionName", "City")
setnames(hviCondoCounty, "RegionName", "County")
setnames(hviCondoState, "RegionName", "State")
setnames(hviSFHZip, "RegionName", "Zip")
setnames(hviSFHCity, "RegionName", "City")
setnames(hviSFHCounty, "RegionName", "County")
setnames(hviSFHState, "RegionName", "State")
setnames(hvi1brZip, "RegionName", "Zip")
setnames(hvi1brCity, "RegionName", "City")
setnames(hvi1brCounty, "RegionName", "County")
setnames(hvi1brState, "RegionName", "State")
setnames(hvi2brZip, "RegionName", "Zip")
setnames(hvi2brCity, "RegionName", "City")
setnames(hvi2brCounty, "RegionName", "County")
setnames(hvi2brState, "RegionName", "State")
setnames(hvi3brZip, "RegionName", "Zip")
setnames(hvi3brCity, "RegionName", "City")
setnames(hvi3brCounty, "RegionName", "County")
setnames(hvi3brState, "RegionName", "State")
setnames(hvi4brZip, "RegionName", "Zip")
setnames(hvi4brCity, "RegionName", "City")
setnames(hvi4brCounty, "RegionName", "County")
setnames(hvi4brState, "RegionName", "State")
setnames(hvi5brZip, "RegionName", "Zip")
setnames(hvi5brCity, "RegionName", "City")
setnames(hvi5brCounty, "RegionName", "County")
setnames(hvi5brState, "RegionName", "State")
setnames(hvisqZip, "RegionName", "Zip")
setnames(hvisqCity, "RegionName", "City")
setnames(hvisqCounty, "RegionName", "County")
setnames(hvisqState, "RegionName", "State")
...
hviCondoZip$location <- paste0(hviCondoZip$City, ", ", hviCondoZip$State, " ",hviCondoZip$Zip)
hviCondoCity$location <- paste0(hviCondoCity$City, ", ", hviCondoCity$State)
hviCondoCounty$location <- paste0(hviCondoCounty$County, ", ", hviCondoCounty$State)
hviCondoState$location <- paste0(hviCondoState$State)
hviSFHZip$location <- paste0(hviSFHZip$City, ", ", hviSFHZip$State, " ",hviSFHZip$Zip)
hviSFHCity$location <- paste0(hviSFHCity$City, ", ", hviSFHCity$State)
hviSFHCounty$location <- paste0(hviSFHCounty$County, ", ", hviSFHCounty$State)
hviSFHState$location <- paste0(hviSFHState$State)
hvi1brZip$location <- paste0(hvi1brZip$City, ", ", hvi1brZip$State, " ",hvi1brZip$Zip)
hvi1brCity$location <- paste0(hvi1brCity$City, ", ", hvi1brCity$State)
hvi1brCounty$location <- paste0(hvi1brCounty$County, ", ", hvi1brCounty$State)
hvi1brState$location <- paste0(hvi1brState$State)
hvi2brZip$location <- paste0(hvi2brZip$City, ", ", hvi2brZip$State, " ",hvi2brZip$Zip)
hvi2brCity$location <- paste0(hvi2brCity$City, ", ", hvi2brCity$State)
hvi2brCounty$location <- paste0(hvi2brCounty$County, ", ", hvi2brCounty$State)
hvi2brState$location <- paste0(hvi2brState$State)
hvi3brZip$location <- paste0(hvi3brZip$City, ", ", hvi3brZip$State, " ",hvi3brZip$Zip)
hvi3brCity$location <- paste0(hvi3brCity$City, ", ", hvi3brCity$State)
hvi3brCounty$location <- paste0(hvi3brCounty$County, ", ", hvi3brCounty$State)
hvi3brState$location <- paste0(hvi3brState$State)
hvi4brZip$location <- paste0(hvi4brZip$City, ", ", hvi4brZip$State, " ",hvi4brZip$Zip)
hvi4brCity$location <- paste0(hvi4brCity$City, ", ", hvi4brCity$State)
hvi4brCounty$location <- paste0(hvi4brCounty$County, ", ", hvi4brCounty$State)
hvi4brState$location <- paste0(hvi4brState$State)
hvi5brZip$location <- paste0(hvi5brZip$City, ", ", hvi5brZip$State, " ",hvi5brZip$Zip)
hvi5brCity$location <- paste0(hvi5brCity$City, ", ", hvi5brCity$State)
hvi5brCounty$location <- paste0(hvi5brCounty$County, ", ", hvi5brCounty$State)
hvi5brState$location <- paste0(hvi5brState$State)
hvisqZip$location <- paste0(hvisqZip$City, ", ", hvisqZip$State, " ",hvisqZip$Zip)
hvisqCity$location <- paste0(hvisqCity$City, ", ", hvisqCity$State)
hvisqCounty$location <- paste0(hvisqCounty$County, ", ", hvisqCounty$State)
hvisqState$location <- paste0(hvisqState$State)
